...
Original file is located at
    https://colab.research.google.com/drive/1sX3BfLFFPaP4B_MXY_m7Jr1UTVP8rVva
"""
...
fig = go.Figure(go.Bar(x=["male", "female"], y=[total_people_given_reminder, (total_entries - total_people_given_reminder)]))
